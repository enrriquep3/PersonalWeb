...
import "./styles.css";
import RadarChart from '../assets/images/radar.png'
...
function AboutPage(props) {
    ...
    return(
        <div>
            ...
            <Content>
            <p>Hi, my name is Enrrique Pimentel. I'm a creative, problem solver and hard working Web Developer & Designer with experience in  JavaScript,  Node Js, HTML5, WordPress, Elementor  MongoDB, MySQL.</p>
            ...
            <p>I am passionate to build, create and develop new ideas into products and services. Let's Create Amazing Things! </p>
